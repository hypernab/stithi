...
MODEL_PATH = BASE_DIR / "models" / "stithi_activity_rf.pkl"
...
class ActivityRecognitionEngine:
    ...
    def _evaluate_window(self) -> Dict[str, Any]:
        ...
        confidence = float(probabilities_array[activity_id - 1])
        
        # Build probability dict
        probabilities = {
            ACTIVITY_NAMES[class_id]: float(prob)
            for class_id, prob in enumerate(probabilities_array, 1)
        }
